...
ui <- fluidPage(
  ...
  #column(
   # width = 4, # 4 out of 12 columns wide for the left column
  ...
  #column(
   ## width = 8, # 8 out of 12 columns wide for the right column
         leafletOutput("mymap"),
...
server <- function(input, output, session) {
  ...
  view <- boundary |> st_centroid() |> st_coordinates() |> as.numeric()
